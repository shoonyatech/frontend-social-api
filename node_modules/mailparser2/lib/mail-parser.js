...
class MailParser extends Transform {
    ...
    cleanup(err) {
        if (this.curnode && this.curnode.decoder && (this.curnode.decoder.writable || this.curnode.decoder.readable)) {
            this.curnode.decoder.on('end', () => {
                setImmediate(() => { // fix to improve ?
